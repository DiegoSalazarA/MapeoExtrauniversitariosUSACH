...
#Creamos objeto desde la base de datos, seleccionado hoja n?mero 2
...
#Crear Columna Zona, desde la categorizaci?n de las comunas en tres circulos concentricos
...
# ---- 2.1 Analisis por distribuci?n territorial  ----

#  Por Comuna (Estainformaci?n queda disponible para el desarrollo del mapa)
